-- Seed / refresh packages by slug (safe to re-run: upserts on unique slug).
...
(
  ...
  $json$[
    {"day":1,"title":"Arrival Srinagar · Dal Lake","desc":"Pickup from Sheikh ul-Alam International Airport and transfer to a premium houseboat on Dal Lake. Evening Shikara ride to Char Chinar and floating gardens. Dinner on board; early night recommended after travel."},
    {"day":2,"title":"Srinagar → Gulmarg (day excursion)","desc":"After breakfast, scenic drive to Gulmarg (~50 km). Time for Gondola (optional, tickets extra), snow activities in winter, or meadow walks in summer. Return to Srinagar by evening; dinner at hotel / houseboat."},
    {"day":3,"title":"Srinagar → Pahalgam","desc":"Drive along the Lidder river to Pahalgam. En route optional stop at saffron fields and apple orchards (seasonal). Check-in at Pahalgam hotel; short walk on the riverside boardwalk. Dinner at hotel."},
    {"day":4,"title":"Pahalgam valleys · Srinagar","desc":"Morning visit to Betaab Valley and Aru Valley (local union vehicles / pony where required—direct payment). Afternoon drive back to Srinagar; visit Nishat / Shalimar Mughal Gardens if time permits. Overnight Srinagar."},
